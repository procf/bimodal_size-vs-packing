## mpi simulation to create a gel from Equilibrium.gsd
## Takes a suspension of colloids in solvent from thermal
## equilibrium, induces attraction and creates Gelation.gsd
...
## NOTE: requires matching Equilibrium.gsd file
## (Rob Campbell)
...
percent_C1 = 0.75 # volume percent of type 1 colloid
percent_C2 = 0.25 # volume percent of type 2 colloid
...
N_time_steps = 3000000 # number of time steps
...
if os.path.exists('Gelation.gsd'):
  ...
  print("Equilibrium state is being brought to quasi-steady state gelation")
